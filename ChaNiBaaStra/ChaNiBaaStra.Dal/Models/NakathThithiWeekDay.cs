...
namespace ChaNiBaaStra.Dal.Models
{
    ...
    /// Created by MAS IT
    /// </summary>
    public class NakathThithiWeekDay : BaseObject
    {
		public NakathThithiWeekDay()
			// Change this parameter to change the DisplayName 
			// (this name is used in all system messages)
			// property of this object
			: base("Nakath Thithi Week Day") { }

		#region Public Properties
		[Key]
		[Nido.Common.Utilities.Validators.Required]
		[DisplayName("Nakath Thithi Week Day Id")]
		public int NakathThithiWeekDayId { get; set; }
		...
		{ get { return Convert.ToString(NakathThithiWeekDayId); } set { NakathThithiWeekDayId = Convert.ToInt32(value); } }
