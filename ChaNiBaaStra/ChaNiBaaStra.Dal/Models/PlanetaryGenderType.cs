...
namespace ChaNiBaaStra.Dal.Models
{
    ...
    public class PlanetaryGenderType : BaseObject
    {
		...
		{ get { return Convert.ToString(PlanetaryGenderTypeId); } set { PlanetaryGenderTypeId = Convert.ToInt32(value); } }
