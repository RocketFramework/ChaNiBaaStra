...
namespace ChaNiBaaStra.Dal.Models
{
    ...
    public class BeneficCondition : BaseObject
    {
		...
		[Nido.Common.Utilities.Validators.Required]
		[DisplayName("Minute To Remove")]
		public int MinuteToRemove { get; set; }
		...
		{ get { return Convert.ToString(BeneficConditionId); } set { BeneficConditionId = Convert.ToInt32(value); } }
