...
namespace ChaNiBaaStra.Dal.Models
{
    ...
    /// Created by MAS IT
    /// </summary>
    public class RashiThithi : BaseObject
    {
		public RashiThithi()
		...
		[DisplayName("Rashi Thithi Id")]
		public int RashiThithiId { get; set; }
		...
		{ get { return Convert.ToString(RashiThithiId); } set { RashiThithiId = Convert.ToInt32(value); } }
