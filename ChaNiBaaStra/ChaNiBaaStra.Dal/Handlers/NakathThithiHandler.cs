...
{
    /// <summary>
    /// Handler method for NakathThithi Table. You will have one handler for each table.
    /// </summary>
    /// <remarks>
    /// You may write any additional data handling operations
    /// related to NakathThithi table in here.
    /// </remarks>
    public class NakathThithiHandler : HandlerBase<NakathThithi, AstroDatabaseDBContext>
    {
        ...
        /// </remarks>
        public GenericResponse<IEnumerable<NakathThithi>> MyCustomMethod()
        {
            try
            {
                ...
                //
                IEnumerable<NakathThithi> s = this._context.ExecuteStoredProcedure<NakathThithi>("Select * from NakathThithi", null);
                // return UpdateSuccessResponse(<Updated NakathThithi>);
                // return DeleteSuccessResponse(<Deleted NakathThithi>);
                return SelectSuccessResponse(s);
            }
            catch (Exception e)
            {
                return HandleException<IEnumerable<NakathThithi>>(e);
            }
        }
	}
}
