...
{
    /// <summary>
    /// Handler method for RashiThithi Table. You will have one handler for each table.
    /// </summary>
    /// <remarks>
    /// You may write any additional data handling operations
    /// related to RashiThithi table in here.
    /// </remarks>
    public class RashiThithiHandler : HandlerBase<RashiThithi, AstroDatabaseDBContext>
    {
        ...
        /// </remarks>
        public GenericResponse<IEnumerable<RashiThithi>> MyCustomMethod()
        {
            try
            {
                ...
                //
                IEnumerable<RashiThithi> s = this._context.ExecuteStoredProcedure<RashiThithi>("Select * from RashiThithi", null);
                // return UpdateSuccessResponse(<Updated RashiThithi>);
                // return DeleteSuccessResponse(<Deleted RashiThithi>);
                return SelectSuccessResponse(s);
            }
            catch (Exception e)
            {
                return HandleException<IEnumerable<RashiThithi>>(e);
            }
        }
	}
}
