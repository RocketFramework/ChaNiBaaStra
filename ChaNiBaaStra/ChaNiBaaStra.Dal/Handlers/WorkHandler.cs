...
{
    /// <summary>
    /// Handler method for Work Table. You will have one handler for each table.
    /// </summary>
    /// <remarks>
    /// You may write any additional data handling operations
    /// related to Work table in here.
    /// </remarks>
    public class WorkHandler : HandlerBase<Work, AstroDatabaseDBContext>
    {
        ...
        /// </remarks>
        public GenericResponse<IEnumerable<Work>> MyCustomMethod()
        {
            try
            {
                ...
                //
                IEnumerable<Work> s = this._context.ExecuteStoredProcedure<Work>("Select * from Work", null);
                // return UpdateSuccessResponse(<Updated Work>);
                // return DeleteSuccessResponse(<Deleted Work>);
                return SelectSuccessResponse(s);
            }
            catch (Exception e)
            {
                return HandleException<IEnumerable<Work>>(e);
            }
        }
	}
}
