...
{
    /// <summary>
    /// Handler method for PlanetaryGenderType Table. You will have one handler for each table.
    /// </summary>
    /// <remarks>
    /// You may write any additional data handling operations
    /// related to PlanetaryGenderType table in here.
    /// </remarks>
    public class PlanetaryGenderTypeHandler : HandlerBase<PlanetaryGenderType, AstroDatabaseDBContext>
    {
        ...
        /// </remarks>
        public GenericResponse<IEnumerable<PlanetaryGenderType>> MyCustomMethod()
        {
            try
            {
                ...
                //
                IEnumerable<PlanetaryGenderType> s = this._context.ExecuteStoredProcedure<PlanetaryGenderType>("Select * from PlanetaryGenderType", null);
                // return UpdateSuccessResponse(<Updated PlanetaryGenderType>);
                // return DeleteSuccessResponse(<Deleted PlanetaryGenderType>);
                return SelectSuccessResponse(s);
            }
            catch (Exception e)
            {
                return HandleException<IEnumerable<PlanetaryGenderType>>(e);
            }
        }
	}
}
