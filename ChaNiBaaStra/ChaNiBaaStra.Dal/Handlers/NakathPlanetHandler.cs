...
{
    /// <summary>
    /// Handler method for NakathPlanet Table. You will have one handler for each table.
    /// </summary>
    /// <remarks>
    /// You may write any additional data handling operations
    /// related to NakathPlanet table in here.
    /// </remarks>
    public class NakathPlanetHandler : HandlerBase<NakathPlanet, AstroDatabaseDBContext>
    {
        ...
        /// </remarks>
        public GenericResponse<IEnumerable<NakathPlanet>> MyCustomMethod()
        {
            try
            {
                ...
                //
                IEnumerable<NakathPlanet> s = this._context.ExecuteStoredProcedure<NakathPlanet>("Select * from NakathPlanet", null);
                // return UpdateSuccessResponse(<Updated NakathPlanet>);
                // return DeleteSuccessResponse(<Deleted NakathPlanet>);
                return SelectSuccessResponse(s);
            }
            catch (Exception e)
            {
                return HandleException<IEnumerable<NakathPlanet>>(e);
            }
        }
	}
}
