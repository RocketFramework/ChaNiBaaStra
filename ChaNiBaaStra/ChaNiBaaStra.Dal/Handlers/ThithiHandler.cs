...
{
    /// <summary>
    /// Handler method for Thithi Table. You will have one handler for each table.
    /// </summary>
    /// <remarks>
    /// You may write any additional data handling operations
    /// related to Thithi table in here.
    /// </remarks>
    public class ThithiHandler : HandlerBase<Thithi, AstroDatabaseDBContext>
    {
        ...
        /// </remarks>
        public GenericResponse<IEnumerable<Thithi>> MyCustomMethod()
        {
            try
            {
                ...
                //
                IEnumerable<Thithi> s = this._context.ExecuteStoredProcedure<Thithi>("Select * from Thithi", null);
                // return UpdateSuccessResponse(<Updated Thithi>);
                // return DeleteSuccessResponse(<Deleted Thithi>);
                return SelectSuccessResponse(s);
            }
            catch (Exception e)
            {
                return HandleException<IEnumerable<Thithi>>(e);
            }
        }
	}
}
